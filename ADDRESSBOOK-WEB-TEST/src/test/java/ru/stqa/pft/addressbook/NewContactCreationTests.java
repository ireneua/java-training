...
public class NewContactCreationTests {
  ...
  public void NewContact() {
    ...
    login();
    initContactCreation();
    fillContactData(new ContactData("John", "Boris", "Po", "popo", "developer", "Po-dev", "India", "indo@test.com", "indo_double#test.com", "indo_double@test.com", "1986"));
    returnToHomePage();
  }
  ...
  private void fillContactData(ContactData contactData) {
    ...
    wd.findElement(By.name("lastname")).sendKeys(contactData.getLastaname());
    ...
    wd.findElement(By.name("email2")).sendKeys(contactData.getEmail22());
